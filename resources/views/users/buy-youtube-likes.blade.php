@extends('layouts.app')
@section('title', 'Buy Youtube Video Likes')
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7">
                    <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                        <h1 class="text-white mb-0">Buy Youtube Video Likes</h1>
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0">
                                <li class="list-inline-item breadcrumb-item"><a href="#">Home</a></li>
                                <li class="list-inline-item breadcrumb-item"><a href="#">Pages</a></li>
                                <li class="list-inline-item breadcrumb-item active">Buy Youtube Video Likes</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-8">
                    <div class="section-heading text-center mb-5">
                        ...
                        <h2>Youtube Video Likes Price</h2>
            ...
            <div class="row align-items-center justify-content-between mb-5">
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="card-header py-4 border-0 pricing-header">
                            <div class="price text-center mb-0 monthly-price">₦800</div>
                        </div>
                        <div class="price-name">
                            <h5 class="mb-0">BUY 50 Youtube Video Likes</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <a href="{{ route('youtube_video_likes_order') }}" class="btn outline-btn mb-3" target="_blank">Purchase now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 100 Youtube Video Likes</h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mb-4 pricing-feature-list">
                                <li><span>High Quality users</span></li>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 500 Youtube Video Likes</h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mb-4 pricing-feature-list">
                                <li><span>High Quality users</span></li>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 1000 Youtube Video Likes</h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mb-4 pricing-feature-list">
                                <li><span>High Quality users</span></li>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 2k Youtube Video Likes</h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mb-4 pricing-feature-list">
                                <li><span>High Quality users</span></li>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 4k + Youtube Video Likes</h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mb-4 pricing-feature-list">
                                <li><span>High Quality users</span></li>
                ...
                <div class="col-12 text-center">
                    <div class="action-btns mt-5">
                        <a href="{{ route('youtube_video_likes_order') }}" class="btn secondary-solid-btn px-5">CLICK HERE TO SEE MORE PLANS</a>
                    </div>
                </div>
            </div>
        </div>
