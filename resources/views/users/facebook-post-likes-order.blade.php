                ...
                <div class="col-md-10 col-lg-12">
                    <div class="section-heading text-white text-center mb-5">
                        ...
                        <form action="{{ route('order') }}" method="post">
                            @csrf
                            <input type="hidden" name="name" value="facebook_post_likes" required>
                            ...
                            <div class="form-group">
                                <label class="d-block mb-2 text-dark text-left" required>Facebook Post Likes *</label>
                                <select class="form-control w-50" id="quantity" name="quantity">
                                    <option value="">Please Select</option>
                                    <option value="100">100 Post Likes</option>
                                    <option value="500">500 Post Likes</option>
                                    <option value="1000">1000 Post Likes</option>
                                    <option value="5000">5000 Post Likes</option>
                                    <option value="6000">6000 Post Likes</option>
                                    <option value="10000">10000 Post Likes</option>
                                    <option value="20000">20000 Post Likes</option>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ()
        {
            jQuery('select[name="quantity"]').on('change',function(){
               ...
               if(ID == 'other')
               {
                   $('.pay').html('<div class="form-group"><label class="d-block mb-2 text-dark text-left">Any Other Quantity *</label><input class="form-control w-50" type="number" name="quantity" id="search" placeholder="Input Post Likes Quantity" required></div>');
