            ...
            <div class="row">
                <div class="col-md-10 col-lg-12">
                    <div class="section-heading text-white text-center mb-5">
                        ...
                        <p class="text-left" style="color: black"> {{ __('Your accounts have been deactivate by the respective Admin, If you think there is a problem then contact the admin through E-mail.') }}</p>
                    </div>
                </div>
            </div>
        </div>
