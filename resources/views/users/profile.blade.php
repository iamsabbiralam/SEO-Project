                ...
                <div class="section-heading text-white text-center mb-5">
                    ...
                    <form action="{{ route('_profile') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control w-50" type="text" name="name" value="{{ Auth::user()->name }}"
                                placeholder="Enter your Name" required>
                        </div>
                        <div class="form-group text-left">
                            <button type="submit" class="btn secondary-solid-btn mt-3"
                ...
                <div class="section-heading text-white text-center mb-5">
                    ...
                    <form action="{{ route('password') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control w-50" type="password" name="old_password"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control w-50" type="password" name="password_confirmation"
        ...
        <div class="row">
            <div class="col-md-10 col-lg-12">
                <div class="section-heading text-white text-center mb-5">
                    ...
                    <div id="demo">
                        <div class="text-left">
                            <button onclick="passFunction()" class="btn secondary-solid-btn mt-3"
                                style="pointer-events: all; cursor: pointer;">Confirm</button>
                        </div>
                    </div>
                    <div id="pass">
