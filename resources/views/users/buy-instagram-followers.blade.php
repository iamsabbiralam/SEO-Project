@extends('layouts.app')
@section('title', 'Buy Instagram Followers')
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7">
                    <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                        <h1 class="text-white mb-0">Buy Instagram Followers</h1>
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0">
                                <li class="list-inline-item breadcrumb-item"><a href="#">Home</a></li>
                                <li class="list-inline-item breadcrumb-item"><a href="#">Pages</a></li>
                                <li class="list-inline-item breadcrumb-item active">Buy Instagram Followers</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-8">
                    <div class="section-heading text-center mb-5">
                        ...
                        <h2>Instagram Followers Price</h2>
            ...
            <div class="row align-items-center justify-content-between mb-5">
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 1000 Instagram Followers</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 2000 Instagram Followers</h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mb-4 pricing-feature-list">
                                <li><span>High Quality users</span></li>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 5000 Instagram Followers</h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mb-4 pricing-feature-list">
                                <li><span>High Quality users</span></li>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 10000 Instagram Followers</h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mb-4 pricing-feature-list">
                                <li><span>High Quality users</span></li>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 20000 Instagram Followers</h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mb-4 pricing-feature-list">
                                <li><span>High Quality users</span></li>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        ...
                        <div class="price-name">
                            <h5 class="mb-0">BUY 50000 + Instagram Followers</h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mb-4 pricing-feature-list">
                                <li><span>High Quality users</span></li>
                ...
                <div class="col-12 text-center">
                    <div class="action-btns mt-5">
                        <a href="{{ route('instagram_followers_order') }}" class="btn secondary-solid-btn px-5">CLICK HERE TO SEE MORE PLANS</a>
                    </div>
                </div>
            </div>
        </div>
